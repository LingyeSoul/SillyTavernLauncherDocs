...
## 找不到SillyTavernLauncher.exe
请你检查你的杀毒软件，启动器的主程序可能被杀毒软件误报认为是病毒，请将SillyTavernLauncher.exe加入杀毒软件的白名单，并将主程序还原即可。
::: tip 提示
如果不放心作者自己打包的版本，你可以自行打包，打包方法可以参考仓库主页readme中的打包教程。
:::
